        ...
        <section class="section bg-white" id="docs" style="padding-bottom: 150px; padding-top: 10px;">
            <div class="container">
                <div class="row justify-content-center text-center">
                    <div class="col-lg-6">
                        <div class="section-head section-head-s2">
                            <h2 class="title title-xl" title="ABOUT COMPANY">DOCUMENTATION</h2>
                            <p>
                                Basic information about the company, more information can be obtained on a personal request. </p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row gutter-vr-50px">
                        <div class="col-sm-6 col-lg-3">
                            ...
                            <div class="doc">
                                ...
                                <div class="doc-text">
                                    <h5 class="doc-title title-sm">PRIVACY STATEMENT</h5>
                            ...
                            <div class="doc">
                                ...
                                <div class="doc-text">
                                    <h5 class="doc-title title-sm">
                                        PUBLIC OFFER AGREEMENTS</h5>

                                    <div class="doc-lang">
                                        for registered users</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-lg-3">
