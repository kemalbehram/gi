                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.news.store') }}"  enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="title1" class="form-control{{ $errors->has('title1') ? 'is-invalid':''}}" name="title1" value="{{ old('title1') }}" required>
                        ...
                        <div class="mb-3 col-lg-2">
                            <label for="resume">Аватар новости</label>
                        ...
                        <div class="form-group">
                            ...
                            <input id="slag" class="form-control{{ $errors->has('slag') ? 'is-invalid':''}}" name="slag" value="{{ old('slag') }}">
                            @if($errors->has('slag'))
