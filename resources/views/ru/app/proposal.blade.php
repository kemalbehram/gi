                            ...
                            <div class="col-xl-6 col-lg-9">
                                <div class="banner-caption cpn tc-light text-center">
                                    <div class="section-head section-head-s2">
                                        ...
                                        <p style="font-size: 1.4rem; color: #dabd75;"><span style="color: white; font-weight: 900;">Global</span><span  style="color: white; "> incom</span> это твой шанс на успех и финансовою свободу</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <main class="nk-pages">
            ...
            <div class="container">
                <div class="row justify-content-center text-center">
                    <div class="col-lg-6">
                        <div class="section-head section-head-s2">
                            <h2 class="title title-xl" title="GLOBAL incom">УСЛОВИЯ ПАРТНЁРСКОЙ ПРОГРАММЫ</h2>
                                  ...
                                  <div class="tbl-header">
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" style="color:#fff;">
                                      <tbody>
                                        ...
                                        <tr>
                                            <td>АСИСТЕНТ ДИРЕКТОРА</td>
                                            <td>100 000</td>
                                            <td>10,5</td>
                                            <td>750</td>
                                        </tr>
                                        <tr>
                                            <td>СТАРШИЙ АСИСТЕНТ ДИРЕКТОРА</td>
                                            <td>150 000</td>
                                            <td>11</td>
                                            <td>1 000</td>
                                        </tr>
                                        <tr>
                                            <td>РЕГИОНАЛЬНЫЙ АСИСТЕНТ ДИРЕКТОРА</td>
                                            <td>200 000</td>
                                            <td>11,5</td>
                                            <td>2 000</td>
                                        </tr>
                    ...
                    <div class="row justify-content-lg-between justify-content-center align-items-center gutter-vr-30px">
                        <div class="col-lg-6 col-mb-10 ">
                            <div class="nk-block-img">
                                ...
                                <img src="{{asset('../images/app-screens/sc-large-a2.png')}}" alt="img">
                            </div>
                        </div>
                        <div class="col-lg-5 order-lg-last">
                            ...
                            <p style="font-size: 1.4rem; color: #dabd75; text-align: end;">С командой <span style="font-weight: 900; color: #000;">Global</span><span  style="color: #000;"> incom</span> кризиса не существует</p>
                        </div>
                    </div>
                </div>
            </div>
